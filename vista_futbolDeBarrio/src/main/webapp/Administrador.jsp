...
<body>
  ...
  <path fill-rule="evenodd"
								...
								<div class="col-sm-2 col-md-2 cabeceraArriba">
									<a href=""> <svg xmlns="http://www.w3.org/2000/svg"
											width="1.6vw" height="1.4vw" fill="currentColor"
  ...
  <path
											...
											width="1.6vw" height="1.6vw" fill="currentColor"
											style="margin-right: 3px; color: white;"
	...
	<main style="background-color: rgba(223, 234, 213, 0.5);">
		...
		<div class="container-fluid mt-5 pt-2">
			<div class="row igual-altura">
				<!-- LINEA ESPACION ENTRE CABECERA Y MAIN -->
				<div class=" col-md-2 col-sm-2" style="color: white">hola</div>
				<div class=" col-md-10 col-sm-10" style="color: white">hola</div>
			</div>
			...
			<div class="row igual-altura ">
				<!-- MENU LATERAL -->
				<div class="col-md-2 col-sm-2 border border-dark menuLateral">
<pre class=" overflow-x: hidden;"><b><span style="text-decoration: underline;">Gestiones</span>
- <a href="" style="text-decoration: none; " class="letraCabeceraAbajo">Eventos</a>
- <a href="" style="text-decoration: none;"  class="letraCabeceraAbajo">Reservas</a>
- <a href="" style="text-decoration: none;"  class="letraCabeceraAbajo">Pagos</a>
- <a href="" style="text-decoration: none;"  class="letraCabeceraAbajo">Estadísticas</a>
<span style="text-decoration: underline; ">Soporte</span>
- <a href="" style="text-decoration: none;"  class="letraCabeceraAbajo">Configuración</a>
- <a href="" style="text-decoration: none;"  class="letraCabeceraAbajo">Ticket</a>
- <a href="" style="text-decoration: none;"  class="letraCabeceraAbajo">Feedback</a>
<span style="text-decoration: underline;">Promociones</span>
- <a href="" style="text-decoration: none;"  class="letraCabeceraAbajo">Descuentos</a>
- <a href="" style="text-decoration: none;"  class="letraCabeceraAbajo">Boletines</a>
<span style="text-decoration: underline;"><a href="" style="text-decoration: none;"  class="letraCabeceraAbajo">Cerrar sesión</a></span>
</b></pre>



				</div>
				<div class=" col-md-10 col-sm-10 contenido border border-dark"><pre>g
				g
				g
				g
				g
