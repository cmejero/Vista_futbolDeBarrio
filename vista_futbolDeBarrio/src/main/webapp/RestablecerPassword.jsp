  ...
  <div class="formularioInicioSesion mb-4">
    ...
    <form action="restablecerPassword" method="POST">
      ...
      <div class="mb-3">
        ...
        <input type="password" class="campoFormulario" name="password" id="password" required>
      </div>

      <div class="mb-3">
        <label for="passwordConfirm" class="etiquetaFormulario">Confirmar contraseña:</label>
        <input type="password" class="campoFormulario" name="passwordConfirm" id="passwordConfirm" required>
      </div>
