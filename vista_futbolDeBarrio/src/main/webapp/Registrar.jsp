	...
	<main style="background-color: rgba(223, 234, 213, 0.5);">
		...
		<div class="container-fluid mt-4 pt-5"
			...
			<div class="row ">
				...
				<div
					class="col-md-12 col-sm-12 d-sm-block d-md-block d-none columnaBotonRegistrar mb-2">
 ...
 Sevilla, España</pre>
  ...
  <path
	...
	document.addEventListener("DOMContentLoaded", function() {
	    ...
	    const mostrarArbitroBtnX = document.getElementById('mostrarArbitroBtnX');
	    ...
	    function activarBoton(boton) {
	        [mostrarUsuarioBtn, mostrarInstalacionBtn, mostrarClubBtn, mostrarArbitroBtn,
	         mostrarUsuarioX, mostrarInstalacionBtnX, mostrarClubBtnX, mostrarArbitroBtnX].forEach(btn => {
	    ...
	    mostrarArbitroBtnX.addEventListener('click', function(event) {
	        event.preventDefault();
	        mostrarContenedor(arbitroContainer);
	        activarBoton(mostrarArbitroBtnX);
	        arbitroContainer.style.height = "60vw";
	    });
