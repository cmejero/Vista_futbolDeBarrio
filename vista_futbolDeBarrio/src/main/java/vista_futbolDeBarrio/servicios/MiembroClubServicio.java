...
public class MiembroClubServicio {
    ...
    public void guardarMiembroClub(MiembroClubDto miembro) {
        try {
            ...
            json.put("fechaBajaUsuario", miembro.getFechaBajaUsuario() != null ? miembro.getFechaBajaUsuario().toString() : JSONObject.NULL);
        ...
        try {
            ...
            if (responseCode == HttpURLConnection.HTTP_OK) {
                ...
                for (int i = 0; i < jsonLista.length(); i++) {
                    ...
                    miembro.setFechaAltaUsuario(LocalDate.parse(jsonMiembro.getString("fechaAltaUsuario")));
                    if (!jsonMiembro.isNull("fechaBajaUsuario")) {
                        miembro.setFechaBajaUsuario(LocalDate.parse(jsonMiembro.getString("fechaBajaUsuario")));
                    }
