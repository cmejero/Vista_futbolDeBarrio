...
.containerPago {
	max-width: 70vw;
	background: linear-gradient(to bottom, #fffbe0, #fff8c2);
	padding: 2.5vw;
	border-radius: 15px;
...
<script
	src="https://www.paypal.com/sdk/js?client-id=ATYZDfGDp-jdtH5OymJeo0kZDJU4mKs_lTLdYpncddrLMUmItN9zQ7E5vb6OK4F491vKX-3QeFhH4oV7&currency=EUR"></script>
</head>
<body>
	<header class="fixed-top">


		<!-- Contenedor principal de jugador -->
		<%
								...
								<div class="col-sm-5 col-md-5 ">
									<div class="row  ">
										...
										<div class="col-sm-3 col-md-3 cabeceraAbajo ">
											<a href="" class="letraCabeceraAbajo">INICIO</a>
										</div>
  ...
  <path
	...
	<main style="">
		<%
		String mensajePago = request.getParameter("mensajePago");
		if ("exitoso".equals(mensajePago)) {
		%>
		<div class="alert alert-success text-center">¡Pago realizado
			correctamente! Ahora tienes Premium.</div>
		<%
		} else if ("cancelado".equals(mensajePago)) {
		%>
		<div class="alert alert-warning text-center">Pago cancelado. No
			se ha realizado ninguna transacción.</div>
		<%
		} else if ("error".equals(mensajePago)) {
		%>
		<div class="alert alert-danger text-center">Ha ocurrido un error
			durante el pago. Inténtalo de nuevo.</div>
		<%
		}
		%>
		...
		<div class="containerPago">
			...
			<div class="beneficios-premium">
				<h2 style="color: #a67c00; font-size: 1.5vw; margin-bottom: 1.2vw;">Beneficios
					de ser usuario Premium</h2>
				<ul style="list-style: none; padding: 0; font-size: 1.2vw;">
					<li style="margin-bottom: 0.8vw;">⭐ Acceso a estadísticas
						exclusivas..</li>
					<li style="margin-bottom: 0.8vw;">⚡<b>Próximamante:</b>
						Prioridad para reservar instalaciones y torneos.
					</li>
					<li style="margin-bottom: 0.8vw;">💰 <b>Próximamante:</b>
						Descuentos especiales en eventos y servicios.
					</li>
					<li style="margin-bottom: 0.8vw;">🚫 <b>Próximamante:</b>
						Acceso a desafios.
					</li>
			...
			<div class="precio"
				style="margin-bottom: 1.8vw; font-size: 1.4vw; font-weight: bold; color: #b8860b;">
				Costo: 0,99 € / mes</div>

			<div class="paypal-wrapper">
				<div id="paypal-button-container"
					style="width: 90%; max-width: 50vh; min-height: 4vw; overflow: visible; display: flex; justify-content: center; align-items: center; margin: 0 auto;">
				</div>
			</div>
		</div>
	</main>
...
Avenida mujer trabajadora
 Sevilla, España</pre>
  ...
  <path
	...
	<script>
    // Obtener tipo de usuario desde JSP
