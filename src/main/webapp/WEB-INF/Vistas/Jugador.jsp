...
<div class="container-fluid ">
	...
	<main style="background-color: rgba(223, 234, 213, 0.5);">
		...
		<div class="tarjeta-contenedor">
			<!-- Header con nombre, alias, imagen y estado -->
			...
			<div class="tarjeta-estadisticas">
				...
				<div class="tarjeta-estadistica">
					<strong>0</strong>Goles
				</div>
				<div class="tarjeta-estadistica">
					<strong>0</strong>T.Amarillas
				</div>
				<div class="tarjeta-estadistica">
					<strong>0</strong>T.Rojas
				</div>
				<div class="tarjeta-estadistica">
			...
			<div class="tarjeta-iconos">
				<img src="${pageContext.request.contextPath}/Imagenes/icono1.png" alt="Icono 1" class="tarjeta-icono">
				<img src="${pageContext.request.contextPath}/Imagenes/icono2.png" alt="Icono 2" class="tarjeta-icono">
				<img src="${pageContext.request.contextPath}/Imagenes/icono3.png" alt="Icono 3" class="tarjeta-icono">
				<img src="${pageContext.request.contextPath}/Imagenes/icono4.png" alt="Icono 4" class="tarjeta-icono">
				<img src="${pageContext.request.contextPath}/Imagenes/icono5.png" alt="Icono 5" class="tarjeta-icono">
			</div>
		</div>
	</main>
