            ...
            <path
							...
							<div class="row p-1"
								...
								<div
									...
									<a href="${pageContext.request.contextPath}/club/eventos" class="letraCabeceraAbajo "
										...
										<ul class="dropdown-menu dropdown-menu-dark"
											...
											<li><a class="dropdown-item seccion-bloqueada"
												href="Jugador.jsp">Alquileres <span
													class="tooltip-text">Sección en desarrollo</span></a></li>
											<li><a class="dropdown-item " href="${pageContext.request.contextPath}/club/plantilla"
