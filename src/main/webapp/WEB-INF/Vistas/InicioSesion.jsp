...
<body>
									...
									<div class="row">
										...
										<div class="col-sm-2 col-md-2 cabeceraMedio"
											...
											<a href="${pageContext.request.contextPath}/login"
												class="letraCabeceraMedio"  style="color: #d4af37;">INICIAR SESION</a>
										</div>
										<div class="col-sm-2 col-md-2 cabeceraMedio"
							...
							<div class="row ">
								...
								<div class="d-sm-none d-md-none col-12 d-block"
									...
									<div
											...
											<a href="${pageContext.request.contextPath}/login" class="letraCabeceraMedio"
												style="color: #d4af37; text-decoration: underline; font-size:1.8vw">INICIAR SESIÓN</a>
										</div>
	...
	<main style="background-color: rgba(223, 234, 213, 0.5);">
		...
		<div class="alert alert-info text-center">Sesión recordada
			automáticamente.</div>
		<%
		} else if ("clave_actualizada".equals(mensaje)) {
		%>
		<div class="alert alert-success text-center">Contraseña
			actualizada correctamente. Ya puedes iniciar sesión.</div>
		<%
		} else if ("loginNecesario".equals(mensaje)) {
		%>
		<div class="alert alert-warning text-center">Debes iniciar
			sesión como club para inscribirte en un torneo.</div>
		<%
		} else if ("premiumNecesario".equals(mensaje)) {
		%>
		<div class="alert alert-warning text-center">
			Inicia sesión como <strong>jugador</strong> o <strong>club</strong>
			para hacerte Premium.
		</div>
		<%
		}
		}
...
botonGoogle.addEventListener('click', function() {
    ...
    if (!tipo) {
        alert('Selecciona un tipo de usuario antes de iniciar sesión con Google');
        return;
    }
