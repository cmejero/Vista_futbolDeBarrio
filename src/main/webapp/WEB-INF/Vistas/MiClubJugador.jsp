									...
									<div class="row">
										...
										<div class="col-sm-3 col-md-3 cabeceraAbajo ">
											<a
												...
												class="letraCabeceraAbajo" style="color: #d4af37;">MI
												CLUB</a>
										</div>
										<div class="col-sm-3 col-md-3 cabeceraAbajo ">
											<a
							...
							<div class="row p-1"
								...
								<div
									...
									<a href="${pageContext.request.contextPath}/jugador/misClubes"
										class="letraCabeceraAbajo "
										style="text-decoration: none; font-size: 2.5vw; color: #d4af37;">MI
										CLUB</a>
								</div>
	...
	<main style="background-color: rgba(223, 234, 213, 0.5);">
		...
		<div id="modalVerClubMiClubJugador" class="modalMiClubJugador"
			...
			<div class="modal-contentMiClubJugador">
				...
				<h3 id="modalNombreClubMiClubJugador" class="mb-4">
					<b><u>Miembros del Club</u></b>
				</h3>
