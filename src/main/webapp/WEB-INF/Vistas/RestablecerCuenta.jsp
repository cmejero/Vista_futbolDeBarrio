...
<div class="d-flex justify-content-center align-items-center pt-4 mt-5 mb-5">
  <div class="formularioInicioSesion mb-4">
    ...
    <form action="restablecerCuenta" method="POST">
      ...
      <div class="mb-3">
        <label for="password" class="etiquetaFormulario">Nueva contraseña:</label>
        <input type="password" class="campoFormulario" name="password" id="password" required minlength="8">
      </div>

      <div class="mb-3">
        <label for="passwordConfirm" class="etiquetaFormulario">Confirmar contraseña:</label>
        <input type="password" class="campoFormulario" name="passwordConfirm" id="passwordConfirm" required minlength="8">
      </div>

      <div class="text-center mt-3">
        <button type="submit" class="botonRegistrarCabecera pr-2 pl-2">Actualizar</button>
      </div>
    </form>
  </div>
</div>
