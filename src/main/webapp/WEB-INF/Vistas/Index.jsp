								...
								<div class="col-sm-2 col-md-2 ">
									<div class="row  ">
										...
										<div class="col-sm-11 col-md-11 cabeceraAbajo ">
											<a href="${pageContext.request.contextPath}/inicio" class="letraCabeceraAbajo" style="color: #d4af37;">INICIO</a>
										</div>
									</div>
								</div>
					...
					<div id="demo" class="carousel slide" data-bs-ride="carousel"
						...
						<div class="carousel-inner" style="border: 2px solid black;">
							...
							<div class="carousel-item active" data-bs-interval="3000">
								<a href="${pageContext.request.contextPath}/registrar"> <img
							...
							<!-- Item 3 -->
							<div class="carousel-item" data-bs-interval="3000">
								<a href="${pageContext.request.contextPath}/eventos"><img
		...
		<div class="container-fluid">
			<div class="row justify-content-center indexRegisPrem py-5 gap-4">
				...
				<div class="col-5 col-sm-5 col-10 p-5 m-4 indexRegis">
					<p>
						<b><u style="font-size: 3vw">¡Únete Gratis!</u></b>
					</p>
					<p>Regístrate ahora y comienza a disfrutar de nuestra
						plataforma de fútbol amateur:</p>
					<p style="font-size: 1.6vw">Organiza y participa en torneos.
						Compara tus estadísticas. Conecta con otros jugadores.</p>
					<a href="${pageContext.request.contextPath}/registrar">
				...
				<div class="col-5 col-sm-5 col-10 p-5 m-4 indexPrem">
					<p>
						<b><u style="font-size: 3vw">¡Hazte Premium!</u></b>
					</p>
					<p>Accede a los beneficios exclusivos y futuras
						implementaciones para llevar tu experiencia al siguiente nivel:</p>
					<p style="font-size: 1.6vw">Estadísticas globales y de todos
						los torneos que hayas participado.</p>
					<a
						href="${pageContext.request.contextPath}/login?mensaje=premiumNecesario">
						<button type="button" class="botonPremiumCabecera p-2 mt-2"
							title="Accede a todas las funciones premium y ventajas exclusivas">
							SUSCRIBCIÓN PREMIUM</button>
					</a>
				</div>
			...
			<section class="container my-5">
				<h2 class="text-center mb-5">
					<p style="font-size: 3vw;">
						► <u><b><i>PREGUNTAS FRECUENTES</i></b></u>
				</h2>
				...
				<div class="pregunta-frecuente mb-2">
					<button class="boton-pregunta">¿Cómo puedo inscribirme a
						un torneo?</button>
					<div class="texto-pregunta" style="display: none;">Para
						acceder a un torneo debes primero crear o unirte a un club
						existente, desde ahí podrás ver los torneos disponible e
						inscribirte.</div>
				</div>
				...
				<div class="pregunta-frecuente mb-2">
					...
					<div class="texto-pregunta" style="display: none;">Actualmente
						puedes ver tus estadísticas globales y de cada torneo que
						participes al detalle. En un futuro se implementará mas ventajas,
						como acceso a desafios, prioridad en reservas y más cosas que
						estan por venir.</div>
				</div>
	        ...
	        card.innerHTML =
	            '<div class="card h-100 shadow-sm torneo-card">' +
	                '<div class="card-body d-flex flex-column">' +
	                    ...
	                    '<div class="mt-auto">' +
	                    '<a href="${pageContext.request.contextPath}/login?mensaje=loginNecesario" class="btn w-100" style="background-color: white; color: #005900; border: 2px solid #005900; font-weight: bold;">' +
	                    'Inscribirse' +
	                '</a>' +
	                    '</div>' +
	                '</div>' +
