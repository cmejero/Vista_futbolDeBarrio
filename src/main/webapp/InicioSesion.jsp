									...
									<div class="dropdown">
										...
										<ul class="dropdown-menu dropdown-menu-dark"
											...
											<li><a class="dropdown-item " href="InicioSesion.jsp"
												style="color: #d4af37;">Iniciar sesión </a></li>
											<li>
				...
				<form action="login" method="POST" enctype="multipart/form-data">
					...
					<div class="mb-2">
						...
						<div class="contenedorContrasenia">
							...
							<button type="button" onclick="mostrarContrasena()">👁️</button>
						</div>
					</div>
					...
					<div class="enlaceRegistroGoogle text-center mt-2">
						¿No tienes una cuenta? <a
							href="https://accounts.google.com/lifecycle/steps/signup/name">Regístrate
							aquí</a>
					</div>
				</form>
			</div>
