	    ...
	    protected void doGet(HttpServletRequest request, HttpServletResponse response)
	        ...
	        try {
	        	...
	        	if (tipoUsuario == null || !(tipoUsuario.equals("jugador") || tipoUsuario.equals("club"))) {
	        	    // Revisar también si está la sesión con clubId o usuarioId
	        	    if (session != null && session.getAttribute("usuarioId") != null) {
	        	        tipoUsuario = "jugador";
	        	    } else if (session != null && session.getAttribute("clubId") != null) {
	        	        tipoUsuario = "club";
	        	    } else {
	            ...
	            // Obtener lista de estadísticas desde la capa de servicio
	            ArrayList<JugadorEstadisticaTorneoDto> listaEstadisticas = jugadorEstadisticaTorneoServicio.obtenerTodasJugadorEstadisticasTorneo();
